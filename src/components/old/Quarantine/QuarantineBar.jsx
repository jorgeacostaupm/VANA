...
import { Select, Typography, Space, Card, Button, Slider, Input } from "antd";
import {
  SettingOutlined,
  RollbackOutlined,
  EditOutlined,
...
import LegendButton from "../old/Overview/BarButtons/LegendButton";
import SwitchButton from "../old/Overview/BarButtons/SwitchButton";
import BarButton from "@/utils/BarButton";
import SettingsButton from "../old/Overview/BarButtons/SettingsButton";

const { Text } = Typography;

export default function QuarantineBar({ title, config, updateConfig }) {
  return (
